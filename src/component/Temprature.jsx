  ...
  return (
    <>
      <div className="flex align-middle justify-between">
        <input
          type="text"
          className="bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-md w-50 p-2 focus:outline-none focus:border-slate-400"
      ...
      <div className="flex justify-center items-center text-slate-200 mt-8 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
        ...
        <span className="text-[33px]">*C</span></p>
      </div>
